...
#ifndef INCLUDE_RNXOBS_COM_H_
#define INCLUDE_RNXOBS_COM_H_
#include <iostream>
#include <vector>
...
void m_getPatternName(int ldefined, const char* keyword, const char* param_list, int iyear, int imonth, int iday, int ihour, char* name);

void fillobs(char* line,int nobs,int itemlen,double ver);
}
#endif /* INCLUDE_RNXOBS_COM_H_ */
